...
public class TransactionTableData extends TableData {
    ...
    private static final ImageIcon[] icons
            = new ImageIcon[]{Style.ICON_DATE, Style.ICON_ACCOUNT, Style.ICON_ARTICLE, Style.ICON_AMOUNT, Style.ICON_NOTICE};
    ...
    //нужно цветом зеленым показать доход, и красным цветом показать расход
