...
public class PersonalFinance {
    ...
    public static void main(String[] args) throws Exception {
        ...
        frame.setVisible(true);// делает видимым окно программы!!!
...
//        System.out.println(sd);
    ...
    private static void init() {
        try {
            ...
            Text.init();
            // подключаем текст
            GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();//графическое окружение
...
//        Account ac3 = new Account("Депозит в банке в (RUB)", c1, 100000);
//        Account ac4 = new Account("Депозит в банке в (USD)", c2, 0);
//
...
//        // 25000 получение зарплаты месяц назад 86400 секунд в сутках +000 перевод в миллисекунды *30 в месяце
