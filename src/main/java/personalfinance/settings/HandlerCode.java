 ...
 * @author Леонид
 */
final public class HandlerCode {//обработчик кодов для кнопок для setActionCommand
    ...
    public static final String TYPE = "TYPE";//для графика (расходы по статьям или доходы по статьям)
}


//создание кнопки:
//button.setActionCommand(HandlerCode.MENU_EDIT_ADD);
//
//
//использование кнопки (получать и парсить):
